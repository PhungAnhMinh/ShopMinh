                        ...
                        <table class="table tinfo" style="width: 80%;">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" placeholder="Họ và tên" name="name" value="fullname" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="error">districtID</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="width30 text-right td-right-order">Địa chỉ giao hàng: <span class="require_symbol">* </span></td>
                                    <td>
                                        <textarea name="address" placeholder="Địa chỉ giao hàng:" class="form-control" rows="4" ="" style="height: auto !important;" value="address"></textarea>
                        ...
                        <tbody>
                            ...
                            <td>
                                <tr>
                                    ...
                                    <td style="float: right;">746 VNĐ</td>
                                </tr>
                            </td>
                            <tr>
                                <td colspan="3">
                             ...
                             <td style="float: right;">4567VND</td>
                         </tr>

                         
                            <td colspan="3">Voucher giảm giá: </td>
                            <td>
                            <p style="float:right;">- 7433VNĐ</p> 
