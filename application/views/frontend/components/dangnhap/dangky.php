						...
						<div class="acc_content clearfix" style="display: block;">
							<form accept-charset="UTF-8" action="" id="customer_register" method="post">
								...
								<div class="col_full">
									...
									<div class="error" id="username_error">username</div>
								</div> 
								<div class="col_full">
									...
									<div class="error" id="password_error">password</div>
								</div>
								...
								<div class="col_full">
									...
									<div class="error" id="re_password_error">repassword</div>
								</div>
								<div class="col_full">
									...
									<div class="error" id="name_error">name</div>
								</div>              
								<div class="col_full">
									...
									<div class="error" id="email_error">email</div>
								</div>
								<div class="col_full">
									...
									<div class="error" id="name_error">phone</div>
								</div>
								<div class="col_full nobottommargin">
									...
									<ul>
										<li class="right" style="font-size: 18px;">Nếu đã có tài khoản, hãy <a href="dang-nhap" style="font-size: 19px; color: #0f9ed8;">Đăng nhập</a></li>
									</ul>
								</div>
							</form>
						</div>
