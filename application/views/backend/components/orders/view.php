					...
					<div class="box-body">
						...
						<div id="view">
							<form action="admin/orders/detail/id" enctype="multipart/form-data" method="post" accept-charset="utf-8">
								...
								<h4>Thời gian đặt hàng: <i>order date</i></h4>
								<h4>Địa chỉ: address
								</h4>
								...
								<div class="table-responsive">
									<table class="table table-hover table-bordered">
										...
										<tbody>
											...
											<tr>
												<td colspan="6" class="text-right" style="border: none; font-size: 1.1em;">Tổng cộng: 734657463₫</td>
											</tr>
											<tr>
												<td colspan="6" class="text-right" style="border: none; font-size: 1.1em;">Voucher giảm giá : 47657346₫</td>
											</tr>
											<tr>
											...
											<tr>
												<td colspan="6" class="text-right" style="border: none; color: red; font-size: 1.3em;">Thành tiền: 3746574₫</td>
											</tr>
