    ...
    <section class="sidebar">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li class="active">
                    <a href="/ShopMinh/configuration/update">
